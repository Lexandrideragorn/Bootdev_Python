import pytest
from C9L22_FilteringList import filter_messages
...
marked_submit_cases = [
    pytest.param(*case, marks=pytest.mark.submit) for case in submit_cases
]


@pytest.mark.parametrize(
    ("input", "expected_filtered", "expected_dangs"), run_cases + marked_submit_cases
)
